          ...
          Padding(
            ...
            child: Row(children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Your financial advisor', style: TextStyle(color: c.textSecondary, fontSize: 14)),
              ]),
            ]),
          ),
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, i) => GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(_suggestions[i], style: TextStyle(color: c.textSecondary, fontSize: 14)),
                ),
              ),
            ),
          ),
                    ...
                    child: isUser
                        ? Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                              Text(m.text, style: TextStyle(color: c.background, fontSize: 14, height: 1.5)),
                              const SizedBox(height: 8),
                              Text(m.time, style: TextStyle(color: c.background.withValues(alpha: 0.6), fontSize: 12)),
                            ]),
                          )
                        : GlassCard(
                            padding: const EdgeInsets.all(16),
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text(m.text, style: TextStyle(color: c.textPrimary, fontSize: 14, height: 1.5)),
                              const SizedBox(height: 8),
                              Text(m.time, style: TextStyle(color: c.textSecondary, fontSize: 12)),
                            ]),
                          ),
                  ),
                );
